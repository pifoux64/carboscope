...
<?php // référence à la bibliothèque de fonctions
...
if(isset($_POST['excel'])) {
    ...
    $classeur->getProperties()->setCreator("Carboscope");
    ...
    $feuille->setTitle('Rapport Carboscope');

    $feuille->setCellValueByColumnAndRow(0, 1, 'tLes colonnes débutent à 0 et les lignes débutent à 1');
    $feuille->SetCellValue('A2', 'Il est aussi possible d\'utiliser la notation LettreChiffre (ex : A2)');
    
    
    // envoi du fichier au navigateur
     header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'); 
     header('Content-Disposition: attachment;filename="rapportcarboscope.xlsx"'); 
