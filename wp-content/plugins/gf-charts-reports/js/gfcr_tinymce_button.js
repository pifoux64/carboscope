jQuery(document).ready(function($) {	
	...
	tinymce.create("tinymce.plugins.gravityformschartsreports_button", {
		...
		init : function(ed, url) {
			...
			ed.addButton("gfcr_insert", {
				title : "Insert GF Chart",		
				
				tooltip: 'Insert GF Chart',
				image : "http://gravityformschartsreports.termel.fr/wp-content/uploads/sites/8/2017/01/icon-128x128.png",
		...
		getInfo : function() {
			return {
				longname : "Gravity Forms Charts Reports Buttons",
				author : "Termel",
				version : "1"
			};
		}
	...
	tinymce.PluginManager.add("gfcr_button", tinymce.plugins.gravityformschartsreports_button);
