		...
		<li id="qcld_sl_<?php echo get_the_ID()."_".$cnt ?>" class="ilist_img5_list-style-six ilist_img5_listy-style-six-01 ilist_img5_qcld_column<?php echo esc_html__($column); ?>">
			<div class="ilist_img5_qcld_style"><!--col-md-6 col-sm-6-->
				...
				<div class="ilist_img5_list-inner-part-seven">
					<a class="example-image-link" href="<?php echo esc_url($list['qcld_text_image']); ?>" data-lightbox="example-<?php echo $cnt;?>"><div class="ilist_img5_qcld_image_container" style="background: #ddd url(<?php echo esc_url($list['qcld_text_image']);?>) no-repeat center center;
background-size: cover;">
					 ...
					 <div class="ilist_img5_effect-style-seven">
						...
						?>
						<?php 
							if(isset($list['qcld_text_desc']) and $list['qcld_text_desc']!=''){
						?>
							<p>
								<?php 
									if(strlen($list['qcld_text_desc'])>60)
										echo esc_html__(substr($list['qcld_text_desc'],0,60)).'..';
									else
					...
					<!-- upvote section -->
						<div class="upvote-section">
							<span data-post-id="<?php echo get_the_ID(); ?>" data-item-title="<?php echo esc_html__(trim($list['qcld_text_title'])); ?>" data-item-id="<?php echo esc_html__(trim($list['qcld_counter'])); ?>" class="upvote-btn-ilist upvote-on">
