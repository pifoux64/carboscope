	...
	<?php foreach($list_sl as $list) : ?>
		<li id="qcld_sl_<?php echo get_the_ID()."_".$cnt ?>" class="ilist_img1_list-style-five ilist_img1_listy-style-five-01 ilist_img1_qcld_column<?php echo esc_html__($column); ?>" >
			<div class="ilist_img1_qcld_style"><!--col-md-6 col-sm-6-->
				...
				<?php endif; ?>
			   <a class="example-image-link" href="<?php echo esc_url($list['qcld_text_image']); ?>" data-lightbox="example-<?php echo $cnt;?>"><div class="ilist_img1_list-inner-part-five">
					...
					<div class="ilist_img1_effect-style-four"><p class="ilist_img1_qcldtitle"><?php echo $list['qcld_text_title']; ?></p></div>
