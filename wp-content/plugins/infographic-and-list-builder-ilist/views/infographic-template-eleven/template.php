				...
				<div class="list-twentySix-content pinfol9hoverdesccolor pinfol9hovertitlecolor">
					<div class="list-twentySix-avatar">
							<?php 
								...
								}elseif(isset($list['qcld_text_image_fa']) and $list['qcld_text_image_fa']!=''){
					...
					<div class="list-twentySix-upvote">
						<?php if( $upvote == 'on' ) : ?>
							<div class="upvote-section" style="cursor:pointer">
								<span data-post-id="<?php echo get_the_ID(); ?>" data-item-title="<?php echo (trim($list['qcld_text_title'])); ?>" data-item-id="<?php echo esc_html__(trim($list['qcld_counter'])); ?>" class="upvote-btn-ilist upvote-on" style="color: #7b4141;">
