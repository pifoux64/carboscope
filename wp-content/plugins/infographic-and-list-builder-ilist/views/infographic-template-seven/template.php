						...
						<h2 class="sl-title" ><?php echo ($cnt>9?$cnt:'0'.$cnt); ?></h2>
                            ...
                            <div class="list-twentyTwo-upvote">
								...
								<div class="upvote-section" style="cursor:pointer">
									<span data-post-id="<?php echo get_the_ID(); ?>" data-item-title="<?php echo trim($list['qcld_text_title']); ?>" data-item-id="<?php echo esc_html__(trim($list['qcld_counter'])); ?>" class="upvote-btn-ilist upvote-on" style="color:#fff">
							...
							<?php 
								if(isset($list['qcld_text_image']) && $list['qcld_text_image']!=''){
							?>
